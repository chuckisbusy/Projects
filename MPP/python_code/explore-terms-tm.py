...
df_tm["Total_SA"] = total_sasa
df_tm["Hydrophobic_SA"] = hydrophobic_sasa
df_tm["Total_Atom_SA"] = atm_sasa
df_tm["fa_sol"] = fa_sols

os.chdir("/home/cadeniran/ipn/data")
df_tm.to_csv('tm.csv', sep=',')
